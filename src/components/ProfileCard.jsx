...
const ProfileCard = () => {
    ...
    return (
        <motion.div
            ...
            className="bg-[#111] border border-[#333] h-full flex flex-col items-center justify-center relative overflow-hidden group"
        ...
        >
            <div className="z-10 relative flex flex-col items-center justify-center gap-4 p-4 text-center">
                ...
                <motion.div
                    className="inline-flex items-center bg-[#222] px-4 py-2 rounded-full border border-[#333] shadow-lg hover:border-red-500/50 transition-colors cursor-crosshair"
