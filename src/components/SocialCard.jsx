...
const SocialCard = ({ name, handle, url, icon, color = "#ff3333", delay = 0, copyValue }) => {
    ...
    return (
        <CardComponent
            ...
            className="block w-full h-full bg-[#111] border border-[#333] hover:border-red-500 p-6 relative overflow-hidden group transition-colors duration-300 rounded-lg cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500/60"
